...
import IBudzPair from '@budzswap-libs/budz-swap-core/build/IBudzPair.json';
...
var Fetcher = /*#__PURE__*/function () {
  ...
  Fetcher.fetchPairData = function fetchPairData(tokenA, tokenB, provider) {
    try {
      ...
      return Promise.resolve(new Contract(address, IBudzPair.abi, provider).getReserves()).then(function (_ref) {
